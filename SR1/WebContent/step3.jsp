<%
	String check = (String) session.getAttribute("step2done");
	if (check == null || !check.equals("yes"))
	{
	   response.sendRedirect("step2.jsp?msg=Please complete this step");
	}
	else
	{
%>
		...
		<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="index.jsp" style='color: white; font-size: 26px; font-weight: bold; margin-top: 50px;' >XON Labs</a>
				</div>
...
<!-- 						                        	<input type="text" name="emailCode" required="required" placeholder="Email Verification Code" class="form-control" > -->
<!-- 						                        </div> -->
						                        <div class="form-group">
						                        	<label>Mobile Verification Code</label>
						                        	<input type="text" name="mobileCode" required="required" placeholder="Mobile Verification Code" class="form-control" >
						                        </div>
