<%
	String check = (String) session.getAttribute("step1done");
	if (check == null || !check.equals("yes"))
	{
	   response.sendRedirect("step1.jsp?msg=Please complete this step");
	}
	else
	{
%>
		...
		<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="index.jsp" style='color: white; font-size: 26px; font-weight: bold; margin-top: 50px;' >XON Labs (2020)</a>
				</div>
			                    ...
			                    <fieldset>
		                        	<div class="form-top">
		                        		<div class="form-top-left">
		                        			<h3>Step 2 / 4</h3>
		                            		<p>Tell us how do we contact you</p>
											<%
